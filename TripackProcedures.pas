{
 ...
 Translation from Fortran by Richard B. Winston rbwinst@usgs.gov
 ...
 implementation section should be modified in each program to return valid
 results.
 ...
 is discouraged.  In many casses a new boolean variable named GoToN was
 ...
 can be passed to another subroutine where it is treated as a multidemensional
 array.  It is also possible to pass an array element past the beginning of
 the array and have it (and suceeding elements) treated as a separate array
 ...
 to convert the original 2D array indicies to the new 1D array index.
 The function is inligned to improve speed.
 ...
 To adjust for this difference, the order of the indicies of 2D array was
 reversed in translation so IWK(I,J) in Fortran becomes IWK[J-1,I-1] in
 Object Pascal.

 In Fortran, subroutine arguments are passed as "Var" arguements by default.
